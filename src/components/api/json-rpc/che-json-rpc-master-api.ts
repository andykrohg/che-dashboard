...
export class CheJsonRpcMasterApi {
  ...
  private addQueryParams(entrypoint: string): string {
    const params: string[] = [];
    // if (this.cheKeycloak.isPresent() || true) {
    //   params.push(`token=eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJlbkItQzctTjZ6S2dhUFNiMGg5VHVWUm01RktMMDhhUWZ1d0ZTWEdkUkpzIn0..f4EhuI4g_ajTK495UaalNFang4at80Q2O2xHawW4LqfH-P6F_09B41KdJRNaSqsqyB6HMVGE62rZv0AKGl0DzBr7TtEDcRk1xiRwIWwzWbtzgWsawIqWydBXHq2lLVjWVm6wjzrk3xfr2PD3uc6K7LoRpht6RVZxF4loRk9lLMofKswLHmkXuWq9Vo9hw36QRVSJ_SU70FaLetlFk1e0JJzrTp6sH79aLs8s2PH6sQc8nx_nlHG51ep8oLaJ5JuZC2HSVlc_ksP6rTvDL_4XEWE887Gnpwa67hXH05jjckga76ezp-NznN97Q0lp10JrywZt5XQjHCXxqcvFysRPbg`);
    // }
    if (this.clientId) {
